...
int main() {
	...
	// TODO: accept input for the new element in the array
		cout << "Enter the name of the Kingdom: ";
		cin >> pKingdom[2].m_name;
		cin.ignore();
		cout << "Enter the number of people living in " << pKingdom[2].m_name << ": ";
		cin >> pKingdom[2].m_population;
		cin.ignore();
	count++;
	cout << "==========\n" << endl;
